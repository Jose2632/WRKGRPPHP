<?php
	...
	function WRKHTMLLST ($mysqli, $DB, $TABLA) {
		...
		<h5 class="modal-title" id="INSmodal">INSERTAR EN PRUEBA</h5>
		...
		<div class="modal-content">
		<div class="modal-header">
		<h5 class="modal-title" id="modalupdparms">ACTUALIZAR EN PRUEBA</h5>
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<span aria-hidden="true">&times;</span>
		</button>
		</div>
	...
	function WRKLSTTBLREAD ($mysqli, $DB, $TABLA) {
		...
		<div class="card">
		<center> 
		<h3><strong><div class="card-header">LST PRUEBAS </div> </strong></h3>
		</center>
